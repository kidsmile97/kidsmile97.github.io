---
title: 算法-数学：最大公因数&最小公倍数
date: 2025-04-09 20:40:22 +0800
categories: [algorithm, math]
tags: [最大公因数, 最小公倍数, 欧基里德算法, 更相减损术, Greatest Common divisor, Least Common multiple]
---
...
a 和 b 的最大公约数，等于 b 和 a - b 的最大公约数；（同上，一个用除法求余，一个用减法）
